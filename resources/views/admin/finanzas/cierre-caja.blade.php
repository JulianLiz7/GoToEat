        ...
        <div class="space-y-4">
            ...
            <form method="POST" action="{{ route('admin.finance.cierre.store') }}">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <button type="button"
                            @click="window.open('{{ route('admin.finance.cierre.preview') }}?cash_counted=' + totalCounted + '&deposit_amount=' + depositAmount + '&denominations=' + encodeURIComponent(denominationJson) + '&notes=' + encodeURIComponent(notes), '_blank')"
                            class="w-full py-3 border border-gray-200 text-gray-600 rounded-xl font-semibold text-sm hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
