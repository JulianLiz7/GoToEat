...
<main class="w-full max-w-container_max px-6 py-16 flex flex-col items-center text-center mt-16">
...
<!-- Success Message -->
<h1 class="font-h1 text-h1 text-on-surface mb-4 max-w-2xl">
            ¡Todo listo! Bienvenido a <span class="text-primary-container">GoToEat</span>
</h1>
<p class="font-body-lg text-body-lg text-on-surface-variant max-w-3xl mb-10">
...
<div class="w-12 h-12 bg-surface-container flex items-center justify-center rounded-lg mb-4 group-hover:bg-primary-container/10 transition-colors">
<span class="material-symbols-outlined text-primary-container" data-icon="monitoring">monitoring</span>
</div>
<h3 class="font-h3 text-body-md font-bold text-on-surface mb-2">Panel en tiempo real</h3>
...
<h3 class="font-h3 text-body-md font-bold text-on-surface mb-2">Gestión de pedidos</h3>
...
<h3 class="font-h3 text-body-md font-bold text-on-surface mb-2">Asistente IA activado</h3>
...
<button class="bg-primary-container text-white px-10 py-4 rounded-lg font-h3 text-body-md font-bold shadow-lg shadow-primary-container/20 hover:scale-105 active:scale-95 transition-all duration-200 w-full sm:w-auto">
                Ir a mi Panel de Control
            </button>
</div>
</main>
<!-- Footer Decoration -->
<footer class="mt-auto py-10 w-full flex justify-center opacity-50">
